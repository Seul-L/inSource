    ...
    <div class="txtfield">
        ...
        <form method="POST" action="/php/connectivity.php">
            ...
            <div class="fieldBlockTop">
                ...
                <input type="tel" name="ma-phone-number" size="40" value="<?php echo($phonenumber); ?>"
    ...
    <div class="notif">
        ...
        <div class="communication-method">
            ...
            <input type="checkbox" name="comm-method" id="chk-email" value="email">
                <label for="chk-email" class="checkbox-label" name="comm-method-email" <?php echo $prefemail; echo $prefboth ?>>Email</label>

            <input type="checkbox" name="comm-method" id="chk-sms" value="sms">
                <label for="chk-sms" class="checkbox-label" name="comm-method-sms" <?php echo $prefsms; echo $prefboth ?>>SMS Message</label>
        </div>
