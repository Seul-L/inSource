...
<div class="txtfield">
  ...
  <form method="POST" action="/php/connectivity.php">
    ...
    <div class="fieldBlockTop">
        ...
        <input type="text" name="ma-last-name" size="40" value="<?php echo($lastname); ?>" id="last-name" class="fieldBlock" disabled="disabled">
    </div>

    <div class="fieldBlockTop">
      <label for="first-name">First Name</label>
      <input type="text" name="ma-first-name" size="40" value="<?php echo($firstname); ?>" id="first-name" class="fieldBlock" disabled="disabled">
    </div>

    <div class="fieldBlockTop">
      <label for="user-name">User Name</label>
      <input type="text" name="ma-user-name" size="40" value="<?php echo($username); ?>" id="user-name" class="fieldBlock" disabled="disabled">
    </div>
    <br>

    <div class="fieldBlockTop lg">
      <label for="user-email">Email</label>
      <input type="text" name="ma-email" size="80" value="<?php echo($email); ?>" id="user-email" class="fieldBlocklg" disabled="disabled">
    </div>


    <div class="fieldBlockTop">
      <label for="user-phone-number">Phone Number</label>
      <input type="text" name="ma-phone-number" size="40" value="<?php echo($phonenumber); ?>" id="user-phone-number" class="fieldBlock">
    </div>
  </form>
  </div>
  <br>
