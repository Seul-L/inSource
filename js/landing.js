...
! function() {
  ...
  window.tram = function(t) {
    ...
    if (q.transition) {
      var L = q.timing.dom;
      if (z.style[L] = h["ease-in-back"][0], !z.style[L])
    ...
    var C = e.frame = function() {
      ...
      N = f(function(e) {
        ...
        e.init = function(e) {
          ...
          q.backface && W.hideBackface && Y(this.el, q.backface.css, "hidden")
      ...
      H = f(F, function(t, e) {
        ...
        t.init = function() {
          e.init.apply(this, arguments), this.current || (this.current = {}, V.perspective && W.perspective && (this.current.perspective = W.perspective, Y(this.el, this.name, this.style(this.current)), this.redraw()))
        }, t.set = function(t) {
    ...
    q.transform && (Q.transform = [H], V = {
      ...
      skewX: [k],
      skewY: [k]
    }), q.transform && q.backface && (V.z = [_, "translateZ"], V.rotateZ = [k], V.scaleZ = [b], V.perspective = [x]);
    var J = /ms/,
      K = /s|\./;
    return t.tram = e
  }(window.jQuery);
    ...
    e.define("navbar", t.exports = function(t, i) {
      ...
      function s(e, n) {
        ...
        r || (r = t.data(n, $, {
          ...
          el: i,
          config: {}
        })), r.menu = i.find(".w-nav-menu"), r.links = r.menu.find(".w-nav-link"), r.dropdowns = r.menu.find(".w-dropdown"), r.button = i.find(".w-nav-button"), r.container = i.find(".w-container"), r.outside = m(r), r.el.off($), r.button.off($), r.menu.off($), f(r), T ? (c(r), r.el.on("setting" + $, h(r))) : (l(r), r.button.on("tap" + $, p(r)), r.menu.on("click" + $, "a", v(r))), w(e, n)
      }
      ...
      function m(e) {
        return e.outside && z.off("tap" + $, e.outside), i.debounce(function(n) {
          if (e.open) {
      ...
      function b(t, n) {
        if (!t.open) {
          t.open = !0, t.menu.addClass(L), t.links.addClass(D), t.button.addClass(q);
          var i = t.config;
          ...
          var r = y(t),
            ...
            s = t.el.height(),
            u = t.el[0];
          if (w(0, u), C.intro(0, u), e.redraw.up(), T || z.on("tap" + $, t.outside), !n) {
            var c = "transform " + i.duration + "ms " + i.easing;
            if (t.overlay && (R = t.menu.prev(), t.overlay.show().append(t.menu)), i.animOver) return O(t.menu).add(c).set({
              x: i.animDirect * a,
              height: r
            }).start({
              x: 0
      ...
      function y(t) {
        var e = t.config,
          n = e.docHeight ? z.height() : _.height();
      ...
      function x(t, e) {
        function n() {
          t.menu.height(""), O(t.menu).set({
            x: 0,
            y: 0
          }), t.menu.removeClass(L), t.links.removeClass(D), t.overlay && t.overlay.children().length && (R.length ? t.menu.insertAfter(R) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
        }
        if (t.open) {
          t.open = !1, t.button.removeClass(q);
          var i = t.config;
          if (("none" === i.animation || !O.support.transform || i.duration <= 0) && (e = !0), C.outro(0, t.el[0]), z.off("tap" + $, t.outside), e) return O(t.menu).stop(), void n();
      ...
      E.ready = E.design = E.preview = function() {
        T = M && e.env("design"), _ = t(document.body), (k = z.find($)).length && (k.each(s), r(), o())
      }, E.destroy = function() {
